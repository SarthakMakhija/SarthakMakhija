...
- :zap: **Personal projects**, I am building an educational project [infer](https://github.com/SarthakMakhija/infer) for implementing Constraint-Based Type Inference in a toy programming language.
...
It has close to 3.3K [downloads](https://crates.io/crates/clearcheck).
...
It has close to 5.2K [downloads](https://crates.io/crates/tinylfu-cached).
